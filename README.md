# AWS CloudFormation Custom Resource for SNS Subcription
...
You can test the custom resource by running `example/subcription.cform`. This only parameter is the name of the lambda function created during the installation.
